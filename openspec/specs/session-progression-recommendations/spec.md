# session-progression-recommendations Specification

## Purpose
TBD - created by archiving change add-explicit-progression-recommendations. Update Purpose after archive.
## Requirements
