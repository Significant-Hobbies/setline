# custom-programme-scheduling Specification

## Purpose

Define device-first authoring, persistence, resolution, and migration behavior
for one bounded custom workout programme.
