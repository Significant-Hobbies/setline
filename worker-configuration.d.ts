/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface CloudflareBindings` (hash: 43c509f2e383587be3fb4faa07d30267)
// Runtime types generated with workerd@1.20260515.1 2026-05-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	ASSETS: Fetcher;
	APPLE_APP_BUNDLE_IDENTIFIER: "com.significanthobbies.setline";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_APP_BUNDLE_IDENTIFIER">> {}
}
