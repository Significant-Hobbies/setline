...
export function GET() {
  const body = [
    ...
    "",
    "## CLI",
    "- Local development: `pnpm --dir site dev` (Astro dev server)",
    "- Site check: `pnpm --dir site check` (TypeScript and Astro validation)",
    "- Native quality: `pnpm quality:native` (xcodegen, simulator tests, release build)",
    "",
    "## Machine surfaces",
